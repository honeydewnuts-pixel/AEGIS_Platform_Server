...
from app.services.neural_features_v3_fallback import FEATURE_DIM, extract_feature_vector

MODEL_PATH = Path(__file__).resolve().parent.parent / "models" / "aegis_neural_v3_fallback.json"
...
class NeuralAssistServiceV3Fallback:
